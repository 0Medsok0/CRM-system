...
## Маршруты
/: Home page.<br><br>
/add_contact: Добавить новый контакт.<br><br>
/contacts:  Просмотр списка всех контактов.<br><br>
/search_contacts: Поиск контактов.<br><br>
/send_email: Отправить электронное письмо контакту.<br><br>
